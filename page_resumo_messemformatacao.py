...
def main():
    ...
    # Ponto de equilibrio
    # =========================
    st.subheader("Ponto de equilibrio (estimativa)")
    ...
    # Preco de venda por 1000 balas (em pesos) - voce ajusta na hora
    ...
    # Custos de MP por kg vindos do .env (pode ajustar se quiser simular)
    ...
    st.markdown("---")
    st.subheader("Custos fixos, folha e pro-labore (em pesos argentinos)")
    ...
    perc_encargos = col_fix4.number_input(
        ...
        min_value=0.0,
        max_value=100.0,
        value=25.0,  # aproximacao: 24-26% de contribuicoes do empregador
        step=1.0,
    ...
    prolabore_por_socio_pesos = col_fix5.number_input(
        ...
        min_value=0.0,
        value=5000.0 * TAXA_BRL_ARS,  # default: 5.000 reais convertidos em pesos
        step=50000.0,
    )
    ...
    if lucro_bruto_1000 <= 0:
        ...
        # =========================
        st.subheader("Impostos sobre o resultado (simulacao)")
        ...
        aliquota_iibb = col_imp1.number_input(
            ...
            min_value=0.0,
            max_value=10.0,
            value=3.5,  # exemplo tipico para comercio
            step=0.1,
        ...
        aliquota_ganancias = col_imp2.number_input(
            ...
            min_value=0.0,
            max_value=40.0,
            value=25.0,  # faixa baixa para empresas pequenas
            step=1.0,
        ...
        # =========================
        st.subheader("Simulacao de lucro liquido com volume planejado")
        ...
        if balas_planejadas > 0 and custo_fixo_total_pesos > 0:
            ...
            # lucro antes de Ganancias (lucro operacional depois de custos fixos e IIBB)
            ...
            # Pergunta pronta para o chat explicando esse lucro liquido
            pergunta_pronta_planejado = (
